document.addEventListener('DOMContentLoaded', function() {
    ...
    botonesEliminar.forEach(function(boton) {
        boton.addEventListener('click', function(event) {
            ...
            if (confirmacion) {
                // Si el usuario confirma, crear el formulario dinámicamente para eliminar al paciente
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = 'index_admin-users.php'; // El archivo que manejará la eliminación

                // Crear un input oculto con el id del paciente
                const inputId = document.createElement('input');
                inputId.type = 'hidden';
                inputId.name = 'id_paciente';
                ...
                form.submit(); // Envía el formulario para eliminar el paciente
            }
        });
    });
});
