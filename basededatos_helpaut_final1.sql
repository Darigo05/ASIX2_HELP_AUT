...
CREATE TABLE IF NOT EXISTS `PACIENTES` (
  ...
  `telefono` VARCHAR(45),
  `espectro_tipo_autismo` VARCHAR(45),
  `tratamiento` TINYINT,
  `activacion_plan` TINYINT,
  `intereses_y_actividades` VARCHAR(100),
  `manejo_emociones` VARCHAR(100),
  `interaccion_social_y_comunicacion` VARCHAR(100),
  `terapia_anterior` TINYINT,
  `descripcion_terapia_anterior` VARCHAR(100),
  `id_padres_hijos` INT,
  `id_psicologo_asignado` INT,
  `tipo_de_plan` INT,
